...
-- 5. write a query to get all the orders where profit is negative (1870 rows)
select * from orders
where profit < 0;
...
select category, customer_name,sales from orders 
...
select category , customer_name, * from orders
